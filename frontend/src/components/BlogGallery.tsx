	...
	return (
		<Container className="flex flex-col max-w-7xl">
			...
			<div className="relative w-full overflow-hidden" ref={containerRef}>
				...
				<button onClick={prevPost} className="absolute -left-2.5 top-1/2 transform -translate-y-1/2 basic text-sm p-2" style={{ transform: 'scaleY(3)' }}>
					&lt;
				</button>
				<button onClick={nextPost} className="absolute -right-2.5 top-1/2 transform -translate-y-1/2 basic text-sm p-2" style={{ transform: 'scaleY(3)' }}>
					&gt;
				</button>
			</div>
		</Container>
